...
import { LeafyGreen, Clock } from 'lucide-react';
...
const UncategorizedCarousel: React.FC<RecipesCarouselProps> = ({ recipes }) => {
    ...
    <div>
      ...
      {recipes.map((recipe, index) => (
        ...
        <div className="flex items-center text-sm text-sky-50 mb-2">
          <LeafyGreen strokeWidth={1.5} className="text-slate-950 bg-sky-50/30 w-7 h-7 p-1 mr-2 border border-white rounded-full flex items-center justify-center" />
...
export default UncategorizedCarousel;